...
RUN cd /usr/local && wget -O node-v12.18.2-linux-x64.tar.gz https://install.ruanzhijun.cn/node-v12.18.2-linux-x64.tar.gz
RUN cd /usr/local && tar zxvf node-v12.18.2-linux-x64.tar.gz && mv node-v12.18.2-linux-x64 nodejs
